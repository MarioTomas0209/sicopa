    ...
    <div class="row align-items-md-stretch mt-5">
        <div class="col-md-6">
            <div
                ...
                <img src="img/sonrisa.jpg" class="img-fluid rounded-top" alt="sonrisa">
        ...
        <div class="col-md-6">
            <div
                class="h-100 text-light p-5 bg-primary border rounded-3">
                <P>DIENTES NUEVOS</P>
                <h2>Implantes</h2>
                ...
                <img src="img/implantes.jpg" class="img-fluid rounded-top" alt="sonrisa">
        ...
        <div class="col-md-6 mt-4">
            <div
                ...
                <img src="img/ortodoncia.jpg" class="img-fluid rounded-top" alt="sonrisa">
        ...
        <div class="col-md-6 mt-4">
            <div
                ...
                <img src="img/blanco.jpg" class="img-fluid rounded-top" alt="sonrisa">
        ...
        <div class="col-md-6 mt-4">
            <div
                ...
                <img src="img/odontopediatra.jpg" class="img-fluid rounded-top" alt="sonrisa">
        ...
        <div class="col-md-6 mt-4">
            <div
                ...
                <img src="img/endodoncia.jpg" class="img-fluid rounded-top" alt="sonrisa">
        ...
        <div class="col-md-6 mt-4">
            <div
                ...
                <img src="img/cirujia.jpg" class="img-fluid rounded-top" alt="sonrisa">
